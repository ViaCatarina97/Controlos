...
// Importação via CDN para evitar erros de build no Vercel
      ...
      <div className="bg-white border-2 border-purple-500 rounded-lg p-6 space-y-6 shadow-xl">
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            ...
            <div className="h-12 flex items-center justify-center text-[10px] text-slate-300 uppercase font-black tracking-widest">Sem registos</div>
          </div>
          <div className="bg-slate-50 border border-slate-200 rounded-lg p-4">
            <div className="flex justify-between items-center mb-2 border-b pb-2">
