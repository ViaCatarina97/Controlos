...
// Mapeamento para ligar os nomes da fatura HAVI às descrições internas do formulário
      ...
      if (result && result.grupos) {
        setLocal(prev => {
          const updatedHaviGroups = prev.haviGroups.map(internal => {
            // Tenta encontrar o grupo extraído que corresponde à nossa descrição interna
            ...
            // Fix: pg was out of scope, using pdfMatch.valor_total instead
